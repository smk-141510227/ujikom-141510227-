...
<head>
    ...
    <!-- Bootstrap Core CSS -->
    <link href="{{url('lancer/vendor/bootstrap/css/bootstrap.min.css')}}" rel="stylesheet">

    <!-- Theme CSS -->
    <link href="{{url('lancer/css/freelancer.min.css')}}" rel="stylesheet">

    <!-- Custom Fonts -->
    <link href="{{url('lancer/vendor/font-awesome/css/font-awesome.min.css')}}" rel="stylesheet" type="text/css">
    <link href="{{url('https://fonts.googleapis.com/css?family=Montserrat:400,700')}}" rel="stylesheet" type="text/css">
    <link href="{{url('https://fonts.googleapis.com/css?family=Lato:400,700,400italic,700italic')}}" rel="stylesheet" type="text/css">
    ...
    <nav id="mainNav" class="navbar navbar-default navbar-fixed-top navbar-custom">
        <div class="container">
            ...
            <div class="navbar-header page-scroll">
                ...
                <a class="navbar-brand" href="#page-top">Aplikasi Penggajian</a>
            </div>
...
<header>
                ...
                <div class="row">
                    ...
                    <div class="footer-col col-md-4">
                        ...
                        <ul class="list-inline">
                            ...
                            <li>
                                <a href="#" class="btn-social btn-outline"><i class="fa fa-fw fa-snapchat"></i></a>
                            </li>
                            <li>
                    ...
                    <div class="footer-col col-md-4">
                        <h3>Tentang Template</h3>
                        <p>Template ini Gratis Untuk dipakai, bootstarp ini dibuat oleh<a href="http://startbootstrap.com">Start Bootstrap</a>.</p>
                    </div>
                </div>
            </div>
        </div>
    ...
    <!-- jQuery -->
    <script src="{{url('lancer/vendor/jquery/jquery.min.js')}}"></script>

    <!-- Bootstrap Core JavaScript -->
    <script src="{{url('lancer/vendor/bootstrap/js/bootstrap.min.js')}}"></script>

    <!-- Plugin JavaScript -->
    <script src="{{url('https://cdnjs.cloudflare.com/ajax/libs/jquery-easing/1.3/jquery.easing.min.js')}}"></script>

    <!-- Contact Form JavaScript -->
    <script src="{{url('lancer/js/jqBootstrapValidation.js')}}"></script>
